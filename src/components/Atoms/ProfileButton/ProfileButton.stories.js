...
export default {
  title: 'Components/Atoms/ProfileButton',
...
export const NameProfileButton = Template.bind({});
NameProfileButton.args = {
  username: "JD",
  image: "",
  size: "md",
};

export const AnonymousProfileButton = Template.bind({});
AnonymousProfileButton.args = {
  username: "",
  image: "",
  size: "",
};
